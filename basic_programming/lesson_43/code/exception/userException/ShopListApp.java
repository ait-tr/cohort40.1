...
import lesson_42.code.exception.userException.ProductValidationException;
import lesson_42.code.exception.userException.ValidationServiceWithException;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                lesson_42.code.exception.userException.Product newProduct = new Product(name, price);
